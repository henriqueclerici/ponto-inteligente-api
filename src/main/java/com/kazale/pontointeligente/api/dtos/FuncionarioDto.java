...
public class FuncionarioDto {
    ...
    @Length(min = 3, max = 200, message = "O tamanho do nome deve ter entre 3 a 200 caracteres")
    ...
    @Length(min = 3, max = 200, message = "O tamanho do email deve estar entre 3 a 200 caracteres")
